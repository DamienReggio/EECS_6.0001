...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        # make sure shift it between 0 and 25
        #
        shift = shift%26
...
class PlaintextMessage(Message):
    ...
    def get_encryption_dict(self):
        ...
        '''
        enc_dict_copy = self.encryption_dict.copy()
    ...
    def change_shift(self, shift):
        ...
        # The Below might be beter, I'm not quite sure
        #
        #self.shift = shift
        #self.message_text_encrypted = self.apply_shift(shift)
        #self.encryption_dict = self.build_shift_dict(shift)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        coding_shift = best_shift % 26
        decrypted_message = self.apply_shift(best_shift)
        decrypted = (coding_shift, decrypted_message)
        return decrypted
...
#    print('Actual Output:', ciphertext.decrypt_message())
    ...
    m = CiphertextMessage('mjqqt mjqqt')
    print(m.decrypt_message())
